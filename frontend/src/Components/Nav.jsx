...
const Nav = ({ setSearchQuery }) => {
  ...
  return (
    <nav className="sticky top-4 z-50 px-6 mb-8">
      <div className="container-custom mx-auto">
        <div className="glass rounded-2xl px-6 py-4 flex items-center justify-between shadow-soft">
          {/* Logo */}
          <Link to="/home" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white font-bold text-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
              L
            </div>
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/home"
              className={`px-5 py-2.5 rounded-full font-semibold transition-all duration-300 ${isActive('/home')
            ...
            <Link
              to="/orders"
              className={`px-5 py-2.5 rounded-full font-semibold transition-all duration-300 ${isActive('/orders')
                  ? 'bg-slate-900 text-white shadow-lg transform scale-105'
                  : 'text-slate-600 hover:bg-slate-100 hover:text-indigo-600'
                }`}
            >
            ...
            <Link
              to="/cart"
              className={`px-5 py-2.5 rounded-full font-semibold flex items-center gap-2 transition-all duration-300 ${isActive('/cart')
